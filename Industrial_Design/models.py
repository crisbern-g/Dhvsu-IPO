...
def custom_upload_path(instance, filename):
    return f'industrial_design/{instance.application.application_name}/{filename}'


class IndustrialDesignApplicationModel(models.Model):
...
class DraftFileModel(models.Model):
    ...
    application = models.ForeignKey(IndustrialDesignApplicationModel, related_name='draft_file', on_delete=models.CASCADE, null=True)
...
class InventionPicturesFileModel(models.Model):
    ...
    application = models.ForeignKey(IndustrialDesignApplicationModel, related_name='invention_pictures', on_delete=models.CASCADE, null=True)
    date_added = models.DateTimeField(auto_now_add=True, editable=False)
    date_modified = models.DateTimeField(auto_now=True)
...
class AbstractFileModel(models.Model):
    ...
    application = models.ForeignKey(IndustrialDesignApplicationModel, related_name='abstract_file', on_delete=models.CASCADE, null=True)
    date_added = models.DateTimeField(auto_now_add=True, editable=False)
    date_modified = models.DateTimeField(auto_now=True)
...
class AuthorIdsFileModel(models.Model):
    ...
    application = models.ForeignKey(IndustrialDesignApplicationModel, related_name='author_ids', on_delete=models.CASCADE, null=True)
    date_added = models.DateTimeField(auto_now_add=True, editable=False)
    date_modified = models.DateTimeField(auto_now=True)
...
class MemorandumOfAppointmentFileModel(models.Model):
    ...
    application = models.ForeignKey(IndustrialDesignApplicationModel, related_name='memorandum_of_appointment', on_delete=models.CASCADE, null=True)
    date_added = models.DateTimeField(auto_now_add=True, editable=False)
    date_modified = models.DateTimeField(auto_now=True)